...
require.config({
    ...
    baseUrl: '/ForwardTutorial',

    paths: {
        Forward: 'dist/Forward',
        main: 'dist/src/main/js',
        // demoapps : 'src/demo-apps',
        template: 'dist/src/main/js/compiler/template-requirejs-plugin',
        jquery: 'https://ajax.googleapis.com/ajax/libs/jquery/2.1.3/jquery',
        async: 'dist/bower_components/requirejs-plugins/src/async',
        socketio: 'dist/node_modules/socket.io-client/dist/socket.io'
    },
    ...
    packages: [
        {'name': 'lodash', 'location': 'dist/node_modules/lodash-amd'},
        {'name': 'text', 'location': 'dist/node_modules/requirejs-text', 'main': 'text.js'},
        {'name': 'cryptojs','location': 'dist/bower_components/crypto-js', 'main': 'index.js'}
    ],
