define(
    /* Class name */
    'main/runtime/_ast/ForDirective',
    ...
    function (Diff, assert, lodash, Directive, ExpressionDirective) {
         ...
         *
         */
        function ForDirective(variable_name, expression, children) {
         ...
         */
        ForDirective.prototype.match = function (diff) {
         ...
         * @returns {ForDirective}
         */
        ForDirective.prototype.shallowClone = function() {
            var clone_directive = new ForDirective(this.variable_name, this.expression);
